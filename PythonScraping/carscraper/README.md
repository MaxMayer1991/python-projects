...
Automated car listings scraper from auto.ria.com with Docker, PostgreSQL, and task scheduler support.
🎯 Features

    ✅ Full Automation - Scheduled execution with APScheduler

    ✅ Docker Compose - One-command deployment

    ✅ PostgreSQL - Reliable data storage with automatic backups

    ✅ Selenium + Scrapy - Bypasses website protection

    ✅ Duplicate Handling - Automatic updating of existing records

    ✅ Web UI - PgAdmin for data visualization
...
Expected output:
    ...
    autoria_postgres   postgres     Up (healthy)           0.0.0.0:5432->5432/tcp
    autoria_scrapy     scrapy_app   Up                     
